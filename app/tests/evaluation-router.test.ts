...
import { EvaluationRouter } from "../src/evaluation-router.js";
...
describe("EvaluationRouter", () => {
    ...
    describe("session pinning", () => {
        ...
        it("getWsUrl uses wss:// for https:// instances", () => {
            const router = new EvaluationRouter(["https://eval1.example.com"]);
    ...
    describe("single instance", () => {
        it("always returns the only configured URL regardless of session ID", () => {
            const router = new EvaluationRouter(SINGLE);
