...
const db: Record<string, React.CSSProperties> = {
    ...
    logo:         { fontSize: 12, fontWeight: 700, letterSpacing: 3, color: "#388bfd", textTransform: "uppercase" } as React.CSSProperties,
    heading:      { fontSize: 26, fontWeight: 700, color: "#e6edf3" },
    subhead:      { fontSize: 14, color: "#8b949e", marginTop: -16 },
    section:      { display: "flex", flexDirection: "column", gap: 12 },
    sectionTitle: { fontSize: 11, fontWeight: 700, color: "#388bfd", letterSpacing: 2, textTransform: "uppercase" } as React.CSSProperties,
